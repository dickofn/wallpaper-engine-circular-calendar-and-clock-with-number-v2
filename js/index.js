...
$(function () {
  ...
  function clockRotation() {
    setInterval(function () {
      ...
      var hoursForDial = hours > 12 ? hours % 12 : hours;
  ...
  function init() {
    ...
    // Fade in/out fourth dial and rotate. Also fade in and animate side elements.
    setTimeout(function () {
      $(".hour-preview").fadeTo(500, 0);
      $(".hour-text").fadeTo(500, 1, function () {
        rotateRing(
          hour,
          sectionsHour,
          charactersHour,
    ...
    // Fade in/out third dial and rotate. Also fade in and animate side elements.
    setTimeout(function () {
